                  ...
                  andNight:(NSInteger)night
{
    ...
    if (components.hour >= night
        || components.hour <= morning) {
        return YES;
    } else {
        return NO;
    }
...
+ (NSDate *)beginYesterday
{
    ...
    return [[NSDate alloc] initWithTimeInterval:-interval sinceDate:beginToday];
}
...
+ (NSDate *)beginDayBeforeYesterday
{
    ...
    return [[NSDate alloc] initWithTimeInterval:-interval sinceDate:beginYesterday];
}
